...
public class MyQueueTest {
	...
	public double first=1.0, second=2.0, third=3.0, fourth=4.0, fivth=5.0, sixth=6.0;
	...
	public void testDequeueStudent() {
		try {
			...
			assertEquals(fourth, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue(false, "This should have caused an QueueUnderflowException");
		}
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(fivth));
